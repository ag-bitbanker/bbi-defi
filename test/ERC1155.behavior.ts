  ...
  describe('like an ERC1155', function () {
    describe('balanceOf', function () {
      ...
      describe('when accounts own some tokens', function () {
        beforeEach(async function () {
          await this.token.mint(this.alice, firstTokenId, firstTokenValue, '0x');
          await this.token.mint(this.bruce, secondTokenId, secondTokenValue, '0x');
        });
    ...
    describe('safeTransferFrom', function () {
      beforeEach(async function () {
        await this.token.mint(this.holder, firstTokenId, firstTokenValue, '0x');
        await this.token.mint(this.holder, secondTokenId, secondTokenValue, '0x');
      });
