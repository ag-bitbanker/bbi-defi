...
export interface BbFixInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface BbFix extends BaseContract {
  connect(runner?: ContractRunner | null): BbFix;
  waitForDeployment(): Promise<this>;

  interface: BbFixInterface;
